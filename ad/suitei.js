      ...
      talkcount=sessionStorage.getItem("talkcount")
        for(i=0;i<keys.length;i++){
          ...
          if(recono==null || talkcount==0){
              ...
              string="sh;"+recolist[keys[keys.length-i]]+"\n"
              if (recolist[keys[keys.length-i]]==1){
                 start=setTimeout(function(){
                  ipcRenderer.sendToHost('hover',"sh;clear\n")
                  ipcRenderer.sendToHost('hover',"sh;1.0\n")
                  console.log("1.0送った")
                 },2500)
              }
                ...
                start=setTimeout(function(){
                 ipcRenderer.sendToHost('hover',"sh;clear\n")
                 ipcRenderer.sendToHost('hover',"sh;2.0\n")
                 console.log("2.0送った")
                },2500)
              }
                ...
                start=setTimeout(function(){
                 ipcRenderer.sendToHost('hover',"sh;clear\n")
                 ipcRenderer.sendToHost('hover',"sh;3.0\n")
                 console.log("3.0送った")
                },2500)
              }
                  ...
                  start=setTimeout(function(){
                    ...
                    setTimeout(function(){
                      ipcRenderer.sendToHost("hover","sh;boost\n")
                          ...
                          setTimeout(function(){
                            ipcRenderer.sendToHost('hover',"sh;clear\n")
                            ipcRenderer.sendToHost('hover', "sh;good\n")
                            setTimeout(function(){
                              ipcRenderer.sendToHost("hover","sh;boost\n")
                            },35000)
                          },2000)
